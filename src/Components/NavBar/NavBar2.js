  ...
  <div className="iconTitle">
    ...
    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
      ...
      <li>
          ...
          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 dark:hover:bg-gray-700 dark:hover:text-amber-400 md:dark:hover:bg-transparent dark:border-gray-700" to="/genres-list">
              Shop By Album
            </Link>
          </li>

          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 dark:hover:bg-gray-700 dark:hover:text-amber-400 md:dark:hover:bg-transparent dark:border-gray-700" to="/myAccount">
              My Account
            </Link>
          </li>
          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 dark:hover:bg-gray-700 dark:hover:text-amber-400 md:dark:hover:bg-transparent dark:border-gray-700" to="/login">
              Login
            </Link>
          </li>
          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 dark:hover:bg-gray-700 dark:hover:text-amber-400 md:dark:hover:bg-transparent dark:border-gray-700" to="/signUp">
              Sign Up
            </Link>
          </li>
      </ul>
