...
<nav className="navClass bg-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-800">
  ...
  <div className="iconTitle">
      ...
      <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 dark:hover:bg-gray-700 dark:hover:text-amber-400 md:dark:hover:bg-transparent dark:border-gray-700" to="/artists-list">
              Shop By Artist
            </Link>
          </li>

          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400" to="/albuns-list">
              Shop By Album
            </Link>
          </li>

          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400 " to="/myAccount">
              My Account
            </Link>
          </li>
          <li>
            <Link className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-100 md:dark:hover:text-amber-400" to="/login">
              Login
            </Link>
          </li>
          <li>
