...
<footer className="bgRock p-4 bg-white  shadow md:px-6 md:py-6">
    <div className="sm:flex sm:items-center sm:justify-between px-5 py-1">
        ...
        <span className="nav-link text-4xl self-center font-semibold whitespace-nowrap dark:text-white">ROCK'NYL</span>
        </Link>
